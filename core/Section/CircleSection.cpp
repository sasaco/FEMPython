...
// kpy,kpz - 曲げによる曲率
// sy,sz - 断面せん断歪
MatrixXd CircleSection::strainStress(Material material, double ex, double thd, double kpy, double kpz,
    double sy, double sz) {
...
// dens - 密度
// l - 要素長さ
VectorXd CircleSection::massInertia(double dens, double l) {
