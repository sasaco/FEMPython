...
class FemMain:
    ...
    def __init__(self):
        ...
        # self.viewModel = None	# 表示モデル
        # self.viewObj = None		# 表示オブジェクト
        # self.bounds = None		# モデル境界
        self.info = None		# モデル情報表示部
        # self.colorBar = None	# カラーバー
        self.resultView = None	# 結果表示設定
        self.viewConfig = None  # モデル表示設定
        self.modalWindow = None	# モーダルウィンドウ

        self.FILE_WINDOW = 0	# ファイル操作ウィンドウ
        self.CALC_WINDOW = 1	# 計算設定ウィンドウ
        self.RESULT_WINDOW = 2	# 結果表示設定ウィンドウ
        self.CONFIG_WINDOW = 3	# コンフィグウィンドウ
